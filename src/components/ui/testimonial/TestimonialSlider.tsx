...
const TestimonialSlider: React.FC = () => {
  ...
  return (
    <div className="testimonial-slider lg:p-10 flex flex-col items-start justify-center">
      <div className="testimonial-container -mt-8 -mb-6">
        <div
          className={`testimonial ${
            transitioning ? "fade-out" : "fade-in"
          } flex flex-col text-balance items-start`}
        >
          <p className="cormorant-infant testimonial-quote text-xl italic text-black text-left w-3/4 max-w-3/4 text-balance">
            {testimonials[currentIndex].quote}
          </p>
          <h4 className="mt-2 font-semibold text-xl text-[#4B4145] text-left">
            {testimonials[currentIndex].author}
          </h4>
        </div>
      </div>
      <div className="dots pl-1 mt-10">
