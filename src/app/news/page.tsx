    ...
    <>
      <main className="flex min-h-screen flex-col items-center">
        ...
        <div className="flex flex-col text-left w-full max-w-6xl mx-auto my-5 p-4 bg-white rounded-lg overflow-hidden">
          <div className="flex flex-row h-[400px] items-stretch my-5">

              <div
                className="w-2/3 bg-cover bg-center rounded-l-lg"
                style={{
            ...
            <div className="w-1/3 bg-[#1a584f] text-white flex flex-col justify-between rounded-r-lg p-8 overflow-hidden">
          ...
          <div className="flex flex-row h-[400px] items-stretch my-5 overflow-hidden">
              <div
                className="w-2/3 bg-cover bg-center rounded-l-lg"
                style={{
          ...
          <div className="flex flex-row h-[400px] items-stretch my-5 overflow-hidden">
              ...
              ></div>
            <div className="w-1/3 p-4 bg-[#1a584f] text-white flex flex-col justify-between rounded-r-lg">
