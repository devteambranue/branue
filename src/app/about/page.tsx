  ...
  return (
    <>
      <main className="flex min-h-screen flex-col">
        ...
        >
        <div className="absolute inset-0 bg-[#1a584f] -mt-10">
        ...
        <div className="w-full my-10 text-center optima-ttf items-center justify-center">
            ...
            <div className="text-center flex flex-col items-center justify-center mb-12">
              ...
              <div className="container text-center text-black space-y-4">
                ...
                <div className="flex justify-evenly items-center flex-wrap">
                  <div className="min-h-[330px] mt-5 bg-white border transition-transform duration-300 hover:translate-y-[-10px] hover:shadow-2xl max-w-xs flex flex-col justify-center items-start rounded-2xl">
                    <p className="text-black min-h-[330px] p-6 relative cormorant-infant text-xl bg-white inline-block rounded-2xl">
                      <span className="bg-[#fe7db0] absolute -top-8 right-20 mr-10  inline-block p-2 rounded-full">
                        <Image
                          src="/info.png"
                          width={50}
                          height={50}
                  ...
                  <div className="min-h-[330px] mt-5 border transition-transform duration-300 hover:translate-y-[-10px] hover:shadow-2xl max-w-xs flex flex-col justify-center items-start p-4 rounded-2xl">
                    <p className="text-black min-h-[330px] relative cormorant-infant text-xl bg-white inline-block p-2 rounded-2xl">
                      <span className="bg-[#fe7db0] absolute -top-12 right-20 mr-8 inline-block p-2 rounded-full">
                        <Image
                          src="/focus.png"
                          width={50}
                          height={50}
                      ...
                      <br />
                      <strong className="text-[#fe7db0] mb-4">Focused:</strong> <br />
                  ...
                  <div className="min-h-[330px] mt-5 border transition-transform duration-300 hover:translate-y-[-10px] hover:shadow-2xl max-w-xs flex flex-col justify-center items-start p-4 rounded-2xl">
                    <p className="text-black min-h-[330px] p-6 relative cormorant-infant text-xl bg-white inline-block p-2 rounded-2xl">
                      <span className="bg-[#fe7db0] absolute -top-12 right-20 mr-9 inline-block p-2 rounded-full">
                        <Image
                          src="/open.png"
                          width={50}
                          height={50}
                      ...
                      <br />
                      <strong className="text-[#fe7db0] mb-4">Open:</strong> <br /> We enjoy the dynamism of the
        ...
        <div className="bg-[#1a584f] flex flex-col justify-centerl items-center">
          <section className="optima-ttf flex flex-col md:flex-row items-center my-10">
            <div className="flex flex-col justify-center items-center ">
              <div className="flex flex-col justify-center items-center">
                <h2 className=" optima-ttf pt-10 text-center text-3xl my-10 font-bold text-[#fe7db0] mb-4">
                  Who We Are
                </h2>  
                <div className="mb-10">
                  <Divider width={150} height={0.5} color="#5ae9d4"/>  
              ...
              <div className="w-3/4 mx-4 flex flex-row px-4 cormorant-infant">
                <div className="mariaContent">
                  <h2 className="text-2xl font-bold text-[#fe7db0]">Marie Davey</h2>
                  <div className="my-4">
                    <Divider width={150} height={0.5} color="#5ae9d4"/>
                  </div>
          ...
          <div className="mb-10">
            <Divider width={1000} height={0.5} color="#5ae9d4"/>  
          </div>
          <section className="container font-sans flex flex-col-reverse md:flex-row items-start my-10">
            <div className="w-full pr-4 cormorant-infant">
              ...
              />
              <h2 className="text-2xl font-bold text-[#fe7db0]">Gemma Maguire</h2>
              <div className="my-4 justify-self-center ml-40">
                <Divider width={150} height={0.5} color="#5ae9d4"/>
              </div>              
          ...
          <section className="container optima-ttf flex flex-col md:flex-row items-start my-10">
            <div className="w-full mx-4 px-4 cormorant-infant">
              ...
              />
              <h2 className="text-2xl font-bold text-[#fe7db0]">Samantha</h2>
              <div className="my-4">
                <Divider width={150} height={0.5} color="#5ae9d4"/>
              </div>  
              <p className="text-xl font-semibold mb-4 text-white">
          ...
          <section className="container font-sans flex flex-col-reverse md:flex-row items-start my-10">
            <div className="w-full pr-4 cormorant-infant">
              <Image
                ...
                className="rounded-lg gemmaImage pl-5"
              />
              <h2 className="text-2xl font-bold text-[#fe7db0]">Catherine&apos;s </h2>
              <div className="my-4 justify-self-center ml-40">
        ...
        <div className="mb-10 mx-2">
          <div className="flex flex-col justify-center items-center">
            <h2 className="optima-ttf pt-10 text-center text-3xl font-bold text-[#fe7db0] mb-5">
